document.addEventListener("DOMContentLoaded", function() {
    ...
    function cadastrar() {
        ...
        let cpf = document.querySelector("#usuarioCpf").value;
        let telefone = document.querySelector("#usuarioTelefone").value;
        let dataNascimento = document.querySelector("#usuarioNascimento").value;
